...
#Changelog
    #1) Overhauled DecimalAddback() as I had made it overcomplicated for what it should be, causing errors with overwriting numbers at end of number with complex values
